...
│
└── python/
    └── string_concatenation_implicit.md
```
...
### 🐍 Python
* [Implicit String Literal Concatenation](./python/string_concatenation_implicit.md) — Documenting compile-time versus runtime boundaries using implicit (`()`) and explicit (`\`) line continuations.
...
│
├── python/
│   ├── string_concatenation_implicit.md # The glorious string discovery!
